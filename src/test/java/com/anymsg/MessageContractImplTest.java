...
import com.anymsg.defs.DoubleDef;
import com.anymsg.defs.LongDef;
import com.anymsg.defs.MessageDef;
import com.anymsg.defs.StringDef;
import com.anymsg.exceptions.CodecException;
...
public class MessageContractImplTest {
    ...
    public void test_multiple_types_of_nested_messages() {
        ...
        assertEquals(1_000_000D, after.getGroup(REPORT_LEG).iterator().next().getField(ORDER_QTY), 0.0001);
